...
# Dynamic range frequency query with point update, using SortedList
...
loc = defaultdict(lambda: SortedList())
loc[0] = SortedList(range(1, N + 1))
...
for _ in range(Q):
    ...
    if q[0] == 1:
        ...
        if x not in loc:
            ...
            res.append(loc[x].bisect_right(r) - loc[x].bisect_left(l))
